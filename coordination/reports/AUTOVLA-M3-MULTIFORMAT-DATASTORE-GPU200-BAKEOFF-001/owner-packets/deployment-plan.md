...
- Owner thread name: `50-OWNER · Deployment`
- model_label: `gpt-5.4`
...
- objective: `Read-only no-surface review to confirm the task introduces no endpoint, serving, RTC, or robot behavior despite telemetry and benchmark additions.`
- context_sources:
  - `coordination/tasks/active/AUTOVLA-M3-MULTIFORMAT-DATASTORE-GPU200-BAKEOFF-001.yaml`
  - `autovla/training/**`
  - `autovla/dataloader/**`
- allowed_write_paths:
  - `coordination/reports/AUTOVLA-M3-MULTIFORMAT-DATASTORE-GPU200-BAKEOFF-001/owner-deployment-plan.md`
...
- stop_boundaries:
  - `REQUEST_CHANGES if endpoint/robot/deployment behavior is implied`
  - `APPROVE_NO_SURFACE if the task remains offline-local only`
...
- Owner report path: `coordination/reports/AUTOVLA-M3-MULTIFORMAT-DATASTORE-GPU200-BAKEOFF-001/owner-deployment-plan.md`
- child report directory: `runs/tmp/AUTOVLA-M3-MULTIFORMAT-DATASTORE-GPU200-BAKEOFF-001/deployment/`
- evidence paths:
  - `runs/tmp/AUTOVLA-M3-MULTIFORMAT-DATASTORE-GPU200-BAKEOFF-001/deployment/`
...
- scan evidence path: `runs/tmp/AUTOVLA-M3-MULTIFORMAT-DATASTORE-GPU200-BAKEOFF-001/deployment/`
