...
M10 adopts bounded contracts, not whole repositories. Official StarVLA
upstream pins are recorded separately from the AutoVLA local engineering-base
commit; a local merge SHA is never represented as an upstream StarVLA revision.
...
| NVIDIA Isaac-GR00T N1.7 GA at `9c7e746b2cd37a810070a98ef41d290a07e806c2` | architecture reference and clean contract implementation | `autovla/models/families/gr00t_n1d7/` | source copy, upstream trainer/deployment stack, checkpoint execution before terms resolution, gated Cosmos access without receipts |
...
| Official StarVLA upstream refs `3422b9f2387b6f682cf02802904a77b23ab13afd` and `236f584ef603817e019b002924b2506a71311f2b` | architecture reference | existing `starVLA/` extension seams | baseline mutation, local-base SHA substitution, direct runtime-parity claim |
| AutoVLA local engineering base `005da344ac96e0e309fbb8a466905879c67dfff6` for this Wave 5 writer | local integration baseline, not upstream | shared M10 registry/config/docs integration | any claim that this commit belongs to official StarVLA |
