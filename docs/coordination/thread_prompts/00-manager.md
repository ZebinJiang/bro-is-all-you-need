...
Own program state, task cards, Owner assignment, review routing, risk records, and user reports. Do not directly implement behavior-changing code when an Owner route is required.
